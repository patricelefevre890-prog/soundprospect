exports.handler = async (event) => {
  ...
  try {
    ...
    if (action === 'email') {
      ...
      const prompt = "Tu es Arnaud, fondateur de Moodstream.ai. Ecris un email naturel et humain a " + name + " qui est un(e) " + type + ".\n\nStructure EXACTE a respecter :\n\n1. Bonjour,\n\n2. Premier paragraphe : Commencer par une courte formule du type je me permets de vous contacter au sujet de... puis se presenter rapidement : je m appelle Arnaud, je suis le fondateur de Moodstream.ai, une solution belge de gestion et diffusion musicale pour les commerces. Une ou deux phrases maximum, simple et direct.\n\n3. Deuxieme paragraphe : Dire qu on imagine qu ils diffusent de la musique dans leur espace (adapter selon le type : salle, surface, salle d attente...) et que l ambiance sonore est importante pour leurs clients. Puis mentionner que les couts UNISONO peuvent etre tres eleves et representer une vraie charge financiere.\n\n4. Troisieme paragraphe : Expliquer ce que fait Moodstream.ai : logiciel de diffusion et gestion musicale, creation d un horaire precis pour chaque jour de la semaine, ambiance qui change automatiquement selon les moments de la journee. Notre equipe, notre IA de conseil ou eux-memes peuvent definir l horaire parfait. Possibilite aussi d ajouter des annonces vocales personnalisees.\n\n5. Quatrieme paragraphe : Musiques 100% libres de droits, economies drastiques sur UNISONO.\n\n6. Appel a l action : essai gratuit 14 jours sans engagement. Devis sur https://www.moodstreamai.com/demande-de-devis ou repondre a cet email pour toute question.\n\n7. Cordialement (uniquement, pas de coordonnees, pas de nom)\n\nTon : humain, simple, direct, comme un vrai email ecrit a la main. Max 220 mots.\n\nReponds UNIQUEMENT en JSON valide sans markdown :\n{\"objet\":\"objet court et direct personnalise\",\"corps\":\"corps complet\"}";
